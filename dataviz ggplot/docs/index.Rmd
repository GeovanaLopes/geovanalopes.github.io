...
```{r plot-exemplo-plotly, echo=T,eval = T, fig.height = 5,  fig.width = 6.5}
...
plotdata <- tidyr::spread(asia, country, lifeExp)
...
hc <- highchart() %>%
  ...
  hc_title(text = "Expectativa de vida por País - Mercosul (Adaptado de Datavis with R)",
           margin = 20,
           align = "left",
